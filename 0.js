$(document).ready(function () {
      var slider_wrapper = new Swiper(".slider-wrapper-0", {
          wrapperClass: "slider-list-0",
      slideClass: "slider-item-0",
      navigation: {
        nextEl: '.next-slide-0',
        prevEl: '.prev-slide-0'
      },
  ...
  loop: true,
    ...
    transition:.2s;
      ...
      document.getElementsByTagName('head')[0].appendChild(slide_contentwe_style);$('.slider-item-0').on('mouseover',function() {
  ...
  $('.slider-item-0').on('mouseout',function() {
    $(this).find('.slide-image').css({
      'transform':'scale(1)',
    });
    $(this).find('.slide-content').css({
